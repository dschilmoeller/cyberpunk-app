...
router.put('/changeCharacterHealth/', rejectUnauthenticated, (req, res) => {
  ...
  pool
    ...
    .catch((err) => {
      console.log(`Error updating character health:`, err);
    });
});
...
router.put('/changeCharacterLuck/', rejectUnauthenticated, (req, res) => {
  ...
  pool
    ...
    .catch((err) => {
      console.log(`Error saving character luck change:`, err);
    });
});
...
router.get('/fetchAdvancementPharma/:id', rejectUnauthenticated, (req, res) => {
  ...
  pool
    ...
    .catch((err) => {
      console.log(`Error fetching owned pharma details`, err);
    });
});
...
router.put('/removeCharacterArmor/:id', rejectUnauthenticated, (req, res) => {
  ...
  pool
    ...
    .catch((err) => {
      console.log(`Error resetting character current armor quality:`, err);
    });
});
...
router.put('/removeCharacterShield/:id', rejectUnauthenticated, (req, res) => {
  ...
  pool
    ...
    .catch((err) => {
      console.log(`Error resetting character current shield quality:`, err);
    });
});
...
router.put('/characteralterclothing/:id', rejectUnauthenticated, (req, res) => {
  ...
  pool
    ...
    .catch((err) => {
      console.log(`Error improving character clothing:`, err);
    });
});
...
router.delete('/deletegamemastercharacter/:id', rejectNonAdmin, (req, res) => {
  ...
  if (req.user.user_type === 2) {
    pool
      .query(charDeleteSqlText, charDeleteSqlParams)
      .then((result) => {
        res.sendStatus(202);
      })
      .catch((err) => {
...
router.put('/cyberwareHumanityChange', rejectUnauthenticated, (req, res) => {
  ...
  pool
    ...
    .catch((err) => {
      console.log(`Error updating perm/temp humanity losses`, err);
    });
});
