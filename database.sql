...
('Basic Neural Link',500,'Artifical Nervous System that allows for the use of different pieces of chipware.  The basic version has 5 sockets. Inclues interfacing plugs to connect to most machines.',2,8,'Hospital','neuralware', false),
...
('Basic Cybereyes',100,'A set of Artificial eyes with 3 option slots. Includes the ability to change colors and patterns, a HUD, simple video recordings, and viewing Augmented Reality',1,4,'Clinic','cyberoptics', false),
...
('Image Processing',500,'When paired in both eyes, allows for reduced difficulties on vision based perception checks.',0,0,'Mall','cyberoptics', false),
('Infrared Imaging',500,'When paired in both eyes, allows for ignoring penalties for darkness, smog, and most smoke.',0,0,'Mall','cyberoptics', false),
...
('Body Plating',25000,'Bonds armor plating directly to the user\'s bone in an extremely unsettling way. Generally considered the last step before one goes full cyborg. Increases armor by 5 and adds 3 health boxes. This armor is also considered Hardened (rules).',2,6,'Hospital','externalware', false),
...
('Cyberleg - Right',500,'Replacement leg. Standard issue looks like an angular robotic limb. Modifications all require installation in both legs to be effective. Grants 1 additional health box.',2,6,'Hospital','cyberleg', false),
('Cyberleg - Left',500,'Replacement leg. Standard issue looks like an angular robotic limb. Modifications all require installation in both legs to be effective. Grants 1 additional health box.',2,6,'Hospital','cyberleg', false),
