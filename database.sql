...
INSERT INTO "cyberware_master"("name","price","description","humanity_loss_min","humanity_loss_max","install_level","type","is_treasure")
VALUES
('Biomonitor',100,'Implant that reads vital signs.',0,0,'Mall','fashionware', false),
('Chemskin',100,'Custom skin biosculpting that can alter the appearance of ones skin to almost any conceivable combination of color, inked tattoos, designs, and the like.',0,0,'Mall','fashionware', false),
('EMP Threading',10,'Metallic lines that run across the body. Highly fashionable combinations are always coming and going.',0,0,'Mall','fashionware', false),
('Light Tattoo',100,'Subdermal patches that can produce colorful, backlit tattoos. Gives +1 Appearance when awesome enough.',0,0,'Mall','fashionware', false),
('Corneal Implant',100,'Color changing lenses implanted in the eyes, allowing for nearly any color/style combination',0,0,'Mall','fashionware', false),
('Skinwatch',100,'Subdermal LED watch',0,0,'Mall','fashionware', false),
('Techhair',100,'Color changing, light emitting, artificial hair. Grants +1 Cool.',0,0,'Mall','fashionware', false),
('Basic Neural Link',500,'Artifical Nervous System that allows for the use of different pieces of chipware. This basic version has 5 sockets. Inclues interfacing plugs to connect to most machines. Only one can be equipped at a time.',2,8,'Hospital','neuralware', false),
('Braindance Recorder',500,'System to record all of a users experience to memory chips.',0,0,'Chip','neuralware', false),
('Kerenzikov',500,'Speedware that artifically boosts a users experiential sense of time. Increases Move by 1 and adds 1 die to most combat rolls for one scene when activated. Deals the user 3 stun damage when the effect wears off.',0,0,'Chip','neuralware', false),
('Sandevistan',2000,'Speedware that artifically boosts a users experiential sense of time. Increases Move by 2 and adds 2 die to most combat rolls for one scene when activated. Deals the user 6 stun damage when the effect wears off.',0,0,'Chip','neuralware', false),
...
('Skill Chip - Fast Talk',500,'Chip that overrides a users muscle memory, gives access to internal databanks, and otherwise gives a user skills they might not otherwise have access to.',0,0,'Chip','neuralware', false),
('Skill Chip - Firearms',500,'Chip that overrides a users muscle memory, gives access to internal databanks, and otherwise gives a user skills they might not otherwise have access to.',0,0,'Chip','neuralware', false),
('Skill Chip - Melee Weapons',500,'Chip that overrides a users muscle memory, gives access to internal databanks, and otherwise gives a user skills they might not otherwise have access to.',0,0,'Chip','neuralware', false),
('Skill Chip - Drive Land',500,'Chip that overrides a users muscle memory, gives access to internal databanks, and otherwise gives a user skills they might not otherwise have access to.',0,0,'Chip','neuralware', false),
('Skill Chip - Performance',500,'Chip that overrides a users muscle memory, gives access to internal databanks, and otherwise gives a user skills they might not otherwise have access to.',0,0,'Chip','neuralware', false),
('Skill Chip - Stealth',500,'Chip that overrides a users muscle memory, gives access to internal databanks, and otherwise gives a user skills they might not otherwise have access to.',0,0,'Chip','neuralware', false),
('Skill Chip - Cryptography',500,'Chip that overrides a users muscle memory, gives access to internal databanks, and otherwise gives a user skills they might not otherwise have access to.',0,0,'Chip','neuralware', false),
('Skill Chip - First Aid',500,'Chip that overrides a users muscle memory, gives access to internal databanks, and otherwise gives a user skills they might not otherwise have access to.',0,0,'Chip','neuralware', false),
('Skill Chip - Gambling',500,'Chip that overrides a users muscle memory, gives access to internal databanks, and otherwise gives a user skills they might not otherwise have access to.',0,0,'Chip','neuralware', false),
('Skill Chip - Language',500,'Chip that overrides a users muscle memory, gives access to internal databanks, and otherwise gives a user skills they might not otherwise have access to.',0,0,'Chip','neuralware', false),
('Tactile Booster',100,'Chip that increases a users sense of touch to the point where they can detect cats and larger sized animals from 20 meters away by placing their hand on a solid surface.',0,0,'Chip','neuralware', false),
('Algernonic Subprocessors I',1000,'A general purpose intelligence booster chip. Gives instant access to all knowledge of an 8th grader.',0,0,'Chip','neuralware', false),
('Algernonic Subprocessors II',5000,'A general purpose intelligence booster chip. Makes the user seem pretty bright.',0,0,'Chip','neuralware', false),
...
('Image Processing',500,'User reduces difficulties on vision based perception checks.',0,0,'Mall','cyberoptics', false),
('Infrared Imaging',500,'User ignores penalties for darkness, smog, and most smoke.',0,0,'Mall','cyberoptics', false),
('MicroOptics',100,'In-eye magnifier allows for zooming in up to 400x.',0,0,'Mall','cyberoptics', false),
('Rad Detector',1000,'Displays ambient radiation as a soft glow in the users surroundings.',0,0,'Clinic','cyberoptics', false),
('HUD Agent',100,'More or less sophisticated digital assistant that appears in the users hud.',0,0,'Clinic','cyberoptics', false),
('Basic Cyberaudio Suite',500,'Artificial system replacing a users inner ear. Includes basic recorder',1,4,'Clinic','cyberaudio', false),
('Hearing Amplifier',100,'Boosts nearby sounds, allowing for reduced difficulties on hearing based perception checks.',0,0,'Mall','cyberaudio', false),
('Level Damper',100,'Dampens loud noises such as gunshots, flash bang grenades, and screams.',0,0,'Mall','cyberaudio', false),
...
('Cybersnake',1000,'Esophogus mounted Heavy Melee Weapon. If the user grapples a victim first, the damage is aggravated.',2,8,'Hospital','internalware', false),
('Gills',1000,'User can breathe underwater.',1,4,'Hospital','internalware', false),
('Grafted Muscles I',1000,'Increases Strength by a small amount without excessive bulking.',1,4,'Hospital','internalware', false),
('Grafted Muscles II',5000,'Increases Strength by a moderate amount with a small amount of bulk.',2,8,'Hospital','internalware', false),
('Grafted Muscles III',25000,'Increases Strength by a large amount. The muscles are apparent but seem natural.',3,9,'Hospital','internalware', true),
('Grafted Muscles IV',75000,'Massively increased Strength without a visible trace courtesy of like, carbon nanorods or some nonsense.',4,12,'Hospital','internalware', true),
('Grafted Muscles V',1000000,'This is probably not real and stories of waifu girls ripping cars in half is therefore no cause for alarm.',5,15,'Hospital','internalware', true),
('Bone Lacing I',1000,'Increases Body by a small amount. Basically nothing you cannot achieve with vitamins.',1,4,'Hospital','internalware', false),
('Bone Lacing II',5000,'Increases Body by a modest amount. Your bones are...pretty strong.',2,8,'Hospital','internalware', false),
('Bone Lacing III',25000,'Increases Body by a large amount. Unironic use of the nickname Old Ironsides is permitted.',3,9,'Hospital','internalware', true),
('Bone Lacing IV',75000,'Massively increased Body courtesy of Vanadium Bones and, um, skin de-tenderizing (.',4,12,'Hospital','internalware', true),
('Bone Lacing V',1000000,'Stories of humans becoming literal brick walls are to be dismissed by all right thinking people.',5,15,'Hospital','internalware',true),
('Nervous System Siliconization I',1000,'Increases Reflexes by a small amount by turning some of your nerves into carbon fiber optics.',1,4,'Hospital','internalware', false),
('Nervous System Siliconization II',5000,'Increases Reflexes by a modest amount. Carbon Fiber Optic nerves again. Pretty cool right.',2,8,'Hospital','internalware', false),
('Nervous System Siliconization III',25000,'Increases Reflexes by a large amount. Very futuristic, your Carbon Fiber Optics endings.',3,9,'Hospital','internalware',true),
('Nervous System Siliconization IV',75000,'Increases Reflexes by an enormous amount. Just say it. Carbon. Fiber. Optics. Rolls off the tongue.',4,12,'Hospital','internalware', true),
('Nervous System Siliconization V',1000000,'Faster than a speeding bullet and slicker than an oil spill. Thank god these don\'t exist, right.',5,15,'Hospital','internalware', true),
('Independent Air Supply',1000,'A third lung made of oxygen tanks. Allows holding ones breath for about an hour.',1,6,'Hospital','internalware', false),
('Midnight Lady Implant',100,'Be a Venus, be the fire, be the desire.',1,2,'Clinic','internalware', false),
('Mr. Studd Implant',100,'All Night. Every Night.',1,2,'Clinic','internalware', false),
('Toxin Binders',500,'Reduces difficulty to resist airborne toxins by 1.',1,4,'Clinic','internalware', false),
...
('Grapple Hand',500,'User can fire their hand 30 meters. It can still feel and grab things. Hand can also just run along the ground and grab things.',0,0,'Clinic','cyberarm', false),
('Medscanner',500,'Built in scanner that assists with diagnosing injury and illness. Reduces First Aid and Paramedic difficulties by 1.',0,0,'Clinic','cyberarm', false),
('Techscanner',500,'Built in scanner for assessing technology. Comes with a variety of probes. Reduces repair and jury rigging difficulties by 1.',0,0,'Clinic','cyberarm', false),
('Tool Hand',500,'Fingers contain a variety of screwdrivers, wrenches, a small drill, and other tools. Never carry a toolbag again!',0,0,'Clinic','cyberarm', false),
('Quick Change Mount',100,'Special mounting that allows arm to be removed or attached as a complex action',0,0,'Clinic','cyberarm', false),
('Subdermal Grip',500,'Allows user to interface with a smartgun without connecting interface plugs.',0,0,'Clinic','cyberarm', false),
('Built-in Gun',500,'A one-handed gun can be built into a cyberarm. Weapon is concealed even if not normally able to be.',0,0,'Clinic','cyberarm', false),
('Big Knucks',100,'Built in armored knuckles. Gives +1 damage to unarmed attacks.',0,0,'Clinic','cyberarm', false),
('Scratchers',100,'Carbo-glass fingernails. Acts as a light melee weapon that is virtually undetectable. Exotic Weapon',0,0,'Clinic','cyberarm', false),
('Rippers',500,'Carbo-glass claws built into the first joint of a finger. Acts as a medium melee weapon that is virtually undetectable. Exotic Weapon.',0,0,'Clinic','cyberarm', false),
('Wolvers',1000,'Titanium claws concealed in the forearm that pop out when making a fist. Does NOT make the noise for trademark reasons. Acts as a heavy melee weapon that is virtually undetectable. Exotic Weapon.',0,0,'Clinic','cyberarm', false),
('Hardened Shielding',1000,'Cyberlimb is immune to the effect of EMP devices.',0,0,'Clinic','cyberarm', false),
('Plastic Covering',100,'Plastic coating for limb, giving it a close to human appearance, if somewhat shiny and angular.',0,0,'Clinic','cyberarm', false),
('Realskinn Covering',500,'Artificial skin covering for cyberlimb. Mimics the feel, temp, and reaction of actual skin.',0,0,'Clinic','cyberarm', false),
('SuperChrome Covering',1000,'Shiny metallic coating for cyberlminb. Self cleaning and polishing, too!',0,0,'Clinic','cyberarm', false),
('Cyberleg - Right',500,'Replacement leg. Standard issue looks like an angular robotic limb. Modifications must be purchased twice and installed in both legs to be effective. Grants 1 additional health box.',2,6,'Hospital','cyberleg', false),
('Cyberleg - Left',500,'Replacement leg. Standard issue looks like an angular robotic limb. Modifications must be purchased twice and installed in both legs to be effective. Grants 1 additional health box.',2,6,'Hospital','cyberleg', false),
('Grip Foot',250,'Foot contains traction enhancing nanofibers similar to a chameleons. Allows climbing at normal speed on non-wet surfaces. User must be barefoot',0,0,'Clinic','cyberleg', false),
('Web Foot',250,'Allows toes to extend and deploy webbing, acting as built in flippers. Allows swimming at normal speed.',0,0,'Clinic','cyberleg', false),
('Spring Heels',250,'Leg contains powerful hydraulics, allowing for some truly impressive leaps. More importantly, allows surviving the landing.',0,0,'Clinic','cyberleg', false),
('Skate Foot',250,'Feet can split apart and deploy inline skates. Movement is doubled over most surfaces when skating.',0,0,'Clinic','cyberleg', false),
('Hardened Shielding',1000,'Cyberlimb is immune to the effect of EMP devices.',0,0,'Clinic','cyberleg', false),
('Plastic Covering',100,'Plastic coating for limb, giving it a close to human appearance, if somewhat shiny and angular.',0,0,'Clinic','cyberleg', false),
('Realskinn Covering',500,'Artificial skin covering for cyberlimb. Mimics the feel, temp, and reaction of actual skin.',0,0,'Clinic','cyberleg', false),
('SuperChrome Covering',1000,'Shiny metallic coating for cyberlminb. Self cleaning and polishing, too!',0,0,'Clinic','cyberleg', false),
...
('Malorian 3516','High powered, custom handgun. Requires special smart ammunition made specifically for this weapon. Can be used in melee as a medium melee weapon once per reload, breathing fire from the base of the grip and dealing aggravated damage.',6,'gun',20,2,7,1,TRUE,150000,TRUE),
('Rhinemetall EMG-86','Heavy Weapon.. Requires a complex action to reload both ammunition and charge pack. Requires custom ammunition. Ignores non-hardened armor, treats hardened armor as non-hardened, deals aggravated damage.',8,'gun',100,1,2,2,FALSE,250000,TRUE),
('Magnetic Shuriken','Exotic Weapon. Attacker has -1 DV on most attacks if target is wearing metallic armor or has more than 1 cyberlimb. Requires repair after each use.',1,'bow',1,3,3,1,TRUE,1000,TRUE),
('Giant Magna-Shuriken','Exotic Weapon. This is an 8 pound piece of razor edged steel honed to an almost fractal level of sharpness. It is wildly dangerous to vehicles, much less people. Requires a Shuriken Battleglove to use.',8,'bow',2,1,1,1,FALSE,10000,TRUE),
...
('Arasaka Whistler','Exotic Weapon. Full sized, pump action crossbow for rapid, silent killing. Can be broken down into a concealable device as a single complex action, or restored in two.',6,'gun',20,2,6,2,TRUE,15000,TRUE),
('Araska Reaper','Exotic Weapon. Handheld, self-recocking crossbow. Often wielded with shuriken in close combat by complete maniacs. Collapses into, or expands from, a single, inscrutable block as a simple action.',4,'gun',10,2,4,1,TRUE,20000,TRUE),
