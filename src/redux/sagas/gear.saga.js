...
function* gearAttributeChange(action) {
  if (action.payload.type === 'cyber_strength') {
    yield axios.put(
      `/api/characters/attributegearchangestrength/${action.payload.charID}`,
      action.payload
    );
  } else if (action.payload.type === 'cyber_body') {
    yield axios.put(
      `/api/characters/attributegearchangebody/${action.payload.charID}`,
      action.payload
    );
  } else if (action.payload.type === 'cyber_reflexes') {
    yield axios.put(
      `/api/characters/attributegearchangereflexes/${action.payload.charID}`,
      action.payload
    );
  } else if (action.payload.type === 'cyber_appearance') {
    yield axios.put(
      `/api/characters/attributegearchangeappearance/${action.payload.charID}`,
      action.payload
    );
  } else if (action.payload.type === 'cyber_cool') {
    yield axios.put(
      `/api/characters/attributegearchangecool/${action.payload.charID}`,
      action.payload
    );
  } else if (action.payload.type === 'cyber_intelligence') {
    yield axios.put(
      `/api/characters/attributegearchangeintelligence/${action.payload.charID}`,
      action.payload
    );
  }
}
...
function* changeGearEquipStatus(action) {
  try {
    yield axios.put(
      `api/characters/changeEquipStatus/${action.payload.tableID}`,
      action.payload
    );
    // Equipping Armor
    if (
      action.payload.item.armor_master_id != undefined &&
      action.payload.equipStatus === true
    ) {
      yield axios.put(
        `api/characters/changeCharacterArmorQuality/${action.payload.charID}`,
        action.payload.item
      );
      yield put({
    ...
    if (
      action.payload.item.armor_master_id != undefined &&
      action.payload.equipStatus === false
    ) {
      yield axios.put(
        `api/characters/removeCharacterArmor/${action.payload.charID}`
      );
      yield put({
        type: 'FETCH_ADVANCEMENT_ARMOR',
        payload: action.payload.charID,
    ...
    // Equipping Shield
    if (
      action.payload.item.shield_master_id != undefined &&
      action.payload.equipStatus === true
    ) {
      yield axios.put(
        `api/characters/changeCharacterShieldQuality/${action.payload.charID}`,
        action.payload.item
      );
      yield put({
    ...
    if (
      ...
      yield axios.put(
        `api/characters/removeCharacterShield/${action.payload.charID}`
      );
      yield put({
        type: 'FETCH_ADVANCEMENT_SHIELD',
        payload: action.payload.charID,
    ...
    if (
      action.payload.item.cyberware_master_id != undefined &&
      action.payload.equipStatus === true
    ) {
      ...
      yield put({
        type: 'CYBERWARE_HUMANITY_CHANGE',
        payload: tempHumanityLossCalculator(
          action.payload.humanity,
          action.payload.item,
      ...
      switch (action.payload.item.type) {
        ...
        case 'fashionware':
          ...
          yield put({
            type: 'CHANGE_CYBERWARE_SLOT_COUNT',
            payload: {
              columnName: 'fashionware_slots',
              newValue: action.payload.charCyberwareSlots.fashionware_slots - 1,
              cyberwareBridgeID:
                action.payload.charCyberwareSlots.cyberware_bridge_id,
            },
          });
          ...
          switch (action.payload.item.name) {
            case 'Basic Neural Link':
              yield put({
                type: 'CHANGE_CYBERWARE_SLOT_COUNT',
                payload: {
                  columnName: 'neuralware_slots',
                  newValue:
                    action.payload.charCyberwareSlots.neuralware_slots + 5,
                  cyberwareBridgeID:
                    action.payload.charCyberwareSlots.cyberware_bridge_id,
                },
              });
            ...
            case 'Algernonic Subprocessors I':
              ...
              yield put({
                ...
                payload: {
                  columnName: 'neuralware_slots',
                  newValue:
                    action.payload.charCyberwareSlots.neuralware_slots - 1,
                  cyberwareBridgeID:
                    action.payload.charCyberwareSlots.cyberware_bridge_id,
                },
              });
          ...
          switch (action.payload.item.name) {
            case 'Basic Cybereyes':
              yield put({
                type: 'CHANGE_CYBERWARE_SLOT_COUNT',
                payload: {
                  columnName: 'cyberoptic_slots',
                  newValue:
                    action.payload.charCyberwareSlots.cyberoptic_slots + 3,
                  cyberwareBridgeID:
                    action.payload.charCyberwareSlots.cyberware_bridge_id,
                },
              });
            ...
            default:
              yield put({
                ...
                payload: {
                  columnName: 'cyberoptic_slots',
                  newValue:
                    action.payload.charCyberwareSlots.cyberoptic_slots - 1,
                  cyberwareBridgeID:
                    action.payload.charCyberwareSlots.cyberware_bridge_id,
                },
              });
          ...
          switch (action.payload.item.name) {
            case 'Basic Cyberaudio Suite':
              yield put({
                type: 'CHANGE_CYBERWARE_SLOT_COUNT',
                payload: {
                  columnName: 'cyberaudio_slots',
                  newValue:
                    action.payload.charCyberwareSlots.cyberaudio_slots + 3,
                  cyberwareBridgeID:
                    action.payload.charCyberwareSlots.cyberware_bridge_id,
                },
              });
            ...
            default:
              yield put({
                ...
                payload: {
                  columnName: 'cyberaudio_slots',
                  newValue:
                    action.payload.charCyberwareSlots.cyberaudio_slots - 1,
                  cyberwareBridgeID:
                    action.payload.charCyberwareSlots.cyberware_bridge_id,
                },
              });
        ...
        case 'internalware':
          yield put({
            type: 'CHANGE_CYBERWARE_SLOT_COUNT',
            payload: {
              columnName: 'internalware_slots',
              newValue:
                action.payload.charCyberwareSlots.internalware_slots - 1,
              cyberwareBridgeID:
                action.payload.charCyberwareSlots.cyberware_bridge_id,
            },
          });
        ...
        case 'externalware':
          yield put({
            type: 'CHANGE_CYBERWARE_SLOT_COUNT',
            payload: {
              columnName: 'externalware_slots',
              newValue:
                action.payload.charCyberwareSlots.externalware_slots - 1,
              cyberwareBridgeID:
                action.payload.charCyberwareSlots.cyberware_bridge_id,
            },
          });
          ...
          switch (action.payload.item.name) {
            ...
            case 'Cyberarm - Left':
              ...
              yield put({
                type: 'CHANGE_CYBERWARE_SLOT_COUNT',
                payload: {
                  columnName: 'cyberarm_slots',
                  newValue:
                    action.payload.charCyberwareSlots.cyberarm_slots + 4,
                  cyberwareBridgeID:
                    action.payload.charCyberwareSlots.cyberware_bridge_id,
                },
              });
            ...
            default:
              yield put({
                ...
                payload: {
                  columnName: 'cyberarm_slots',
                  newValue:
                    action.payload.charCyberwareSlots.cyberarm_slots - 1,
                  cyberwareBridgeID:
                    action.payload.charCyberwareSlots.cyberware_bridge_id,
                },
              });
        ...
        case 'cyberleg':
          switch (action.payload.item.name) {
            ...
            case 'Cyberleg - Left':
              // change slot count
              console.log(
                `action.payload.charCyberwareSlots:`,
                action.payload.charCyberwareSlots
              );
              yield put({
                type: 'CHANGE_CYBERWARE_SLOT_COUNT',
                payload: {
                  columnName: 'cyberleg_slots',
                  newValue:
                    action.payload.charCyberwareSlots.cyberleg_slots + 3,
                  cyberwareBridgeID:
                    action.payload.charCyberwareSlots.cyberware_bridge_id,
                },
              });
            ...
            default:
              yield put({
                ...
                payload: {
                  columnName: 'cyberleg_slots',
                  newValue:
                    action.payload.charCyberwareSlots.cyberleg_slots - 1,
                  cyberwareBridgeID:
                    action.payload.charCyberwareSlots.cyberware_bridge_id,
                },
              });
      ...
      yield put({
        type: 'FETCH_ADVANCEMENT_HUMANITY',
        payload: action.payload.charID,
      });
...
const tempHumanityLossCalculator = (humanity, item, charID, type) => {
  ...
  const newPermLoss =
    type === 'loss'
      ? currentPermLoss + humanityMin
      : currentPermLoss - humanityMin;
  const newTempLoss =
    type === 'loss'
      ? currentTempLoss +
        Math.floor(Math.random() * (humanityMax - humanityMin + 1))
      : currentTempLoss -
        Math.floor(Math.random() * (humanityMax - humanityMin + 1));
  let object;
...
function* changeModEquipStatus(action) {
  try {
    if (
      action.payload.mod.vehicle_mod_master_id != undefined &&
      action.payload.equipStatus === true
    ) {
      ...
      switch (action.payload.mod.name) {
        ...
        case 'Seating Upgrade':
          ...
          const advancementVehicles = yield axios.get(
            `/api/characters/fetchAdvancementVehicle/${action.payload.charID}`
          );
          yield put({
    ...
    const advancementVehicleMods = yield axios.get(
      `/api/characters/fetchAdvancementVehicleMods/${action.payload.charID}`
    );
    yield put({
    ...
    const advancementActiveVehicleMods = yield axios.get(
      `/api/characters/fetchAdvancementActiveVehicleMods/${action.payload.charID}`
    );
    yield put({
  ...
  try {
    ...
    if (action.payload.table === 'char_vehicle_bridge') {
      if (action.payload.useNomadFreebie === true) {
        ...
        const nomadVehicleSlots = yield axios.get(
          `/api/advancement/fetchNomadVehicleSlots/${action.payload.charID}`
        );
...
function* sellItem(action) {
  try {
    ...
    if (
      action.payload.table === 'char_armor_bridge' &&
      action.payload.equippedStatus === true
    ) {
      yield axios.put(
        `api/characters/removeCharacterArmor/${action.payload.charID}`
      );
      ...
      action.payload.table === 'char_armor_bridge' &&
      action.payload.equippedStatus === false
    ) {
      yield put({
        type: 'FETCH_ADVANCEMENT_ARMOR',
        payload: action.payload.charID,
      ...
      action.payload.table === 'char_shield_bridge' &&
      action.payload.equippedStatus === true
    ) {
      yield axios.put(
        `api/characters/removeCharacterShield/${action.payload.charID}`,
...
function* alterClothing(action) {
  ...
  yield axios.put(
    `api/characters/characteralterclothing/${action.payload.item.clothing_bridge_id}`,
    action.payload
  );
  yield axios.put(
    `api/characters/savecharacterbank/${action.payload.charID}`,
    ...
    switch (action.payload.armorType) {
      case 'shield':
        ...
        const characterShield = yield axios.get(
          `api/characters/fetchcharactershield/${action.payload.charID}`
        );
        yield put({
      ...
      case 'armor':
        ...
        const characterArmor = yield axios.get(
          `api/characters/fetchcharacterarmor/${action.payload.charID}`
        );
        yield put({
      ...
      default:
        console.log(
          `Unable to change in play armor value due to bad armorType`
        );
        return;
    }
  } catch (error) {
...
function* changeWeaponClip(action) {
  try {
    ...
    const weaponDetail = yield axios.get(
      `/api/characters/fetchcharacterweapons/${action.payload.charID}`
    );
