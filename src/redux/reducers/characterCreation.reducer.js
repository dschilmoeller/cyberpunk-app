const characterCreation = (state = {
    ...
    attributeSelectionHistory: [], attributeCounter: 0, attributeNumber: 4,
    ...
    skillSelectionHistory: [], skillCounter: 0, skillNumber: 4,
    ...
    switch (action.type) {
        ...
        case 'CREATION_SELECT_ATT':
            return {
                ...
                attributeSelectionHistory: [...state.attributeSelectionHistory, action.payload]
            }
        case 'CREATION_UNDO_SELECT_ATT':
            return {
                ...state,
                [action.payload.att]: 0,
                attributeSelectionHistory: [...state.attributeSelectionHistory.filter(a => a.att !== action.payload.att)]
            }
        ...
        case 'CREATION_UNDO_LAST_SKILL':
            return {
                ...
                skillSelectionHistory: [...state.skillSelectionHistory.filter(a => a.skill !== action.payload.skill)]
            }
