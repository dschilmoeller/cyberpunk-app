...
export default function GameMasterLanding() {
  ...
  for (let i = 0; i < characterList.length; i++) {
    let perc =
      characterList[i].cool +
      characterList[i].cyber_cool +
      characterList[i].perception;
    let totalReflexees =
      characterList[i].reflexes + characterList[i].cyber_reflexes;
    let remainingHumanity =
      40 -
      characterList[i].perm_humanity_loss -
      characterList[i].temp_humanity_loss;
      ...
      <Grid container>
        <Grid item xs={6} padding={1}>
          <Button
            fullWidth
            variant="contained"
            onClick={() => history.push('/gamemastercontacts/')}
          >
            Manage Contacts
          </Button>
        </Grid>
                        ...
                        <TableRow hover>
                          <TableCell align="center">
                            <Button
                              ...
                              sx={{ m: 1 }}
                              onClick={() =>
                                history.push(`/gamemastersheet/${character.id}`)
                              }
                            >
                              {character.handle}
                            </Button>
                          ...
                          <TableCell align="center">
                            {character.humanityLoss}
                          </TableCell>
                          <TableCell align="center">
                            {character.availableExp}
                          </TableCell>
                          <TableCell align="center">
                            {euroBuck}
