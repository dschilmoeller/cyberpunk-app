...
export default function GMGiveGrenade() {
    ...
    const grenadeID = useSelector(store => store.characterGear.grenadeID)
    ...
    for (let i = 0; i < grenadeMaster.length; i++) {
        ...
        grenadeMasterRows.push(createMasterGrenadeData(
                            ...
                            {sortedGrenadeMasterRows.map((row) => {
                                return (
                                    <TableRow hover key={row.name}>
                                        ...
                                        <TableCell align="center"><Button onClick={() => buyGrenade(row)}>Give</Button></TableCell>
                                    </TableRow>
                                );
                            })}
                        </TableBody>
