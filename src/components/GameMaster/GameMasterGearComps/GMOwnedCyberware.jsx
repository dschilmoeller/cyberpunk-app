...
export default function GMOwnedCyberware() {
  ...
  const boughtCyberware = useSelector(
    (store) => store.advancementGear.boughtCyberware
  );
  ...
  return (
    <>
      ...
      <Grid container>
        ...
        <Grid item xs={12}>
          <Item>
            Note: This will restore permanent humanity losses. It will not alter
            slot counts, armor, or health; removing equipped cyberware is NOT
            recommended.
          </Item>
        </Grid>
        <Grid item xs={12}>
              ...
              <FormControlLabel
                control={
                  <Switch
                    ...
                    onChange={(e) => setAllowDeleteEquipped(e.target.checked)}
                  />
                }
        ...
        <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
          ...
          <TableBody>
            {charCyberware.map((item) => {
              if (
                (item.type === selectedList && item.equipped === false) ||
                ...
                return (
                  <React.Fragment key={item.owned_cyberware_id}>
                    <TableRow hover>
                      ...
                      <TableCell align="center">
                        <Button onClick={() => gmRemoveCyberware(item)}>
                          Remove
                        </Button>
                      </TableCell>
                    </TableRow>
