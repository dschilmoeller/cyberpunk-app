  ...
  return (
    <>
      <Grid container paddingTop={3} spacing={1} alignItems="center">
        ...
        <Grid item xs={2}>
          <Button disabled={loading} onClick={() => changeHandle(handle)}>
            Save
          </Button>
        </Grid>
        <Grid item xs={3} textAlign={'center'}>
          Player: {charDetail.player}
        </Grid>
        <Grid item xs={3}>
          <TextField
            disabled={loading}
        ...
        <Grid item xs={2}>
          <Button disabled={loading} onClick={() => changePlayer(player)}>
            Save
          </Button>
        </Grid>
        <Grid item xs={6} textAlign={'center'}>
          Campaign: {charDetail.campaign_name}
        </Grid>
        <Grid item xs={6}>
      ...
      {charDetail.max_xp >= 0 ? (
        <Grid container spacing={2} alignContent={'center'}>
          <Grid item xs={4} textAlign={'center'}>
            Current XP: {charDetail.max_xp}
          </Grid>
          <Grid item xs={4} textAlign={'center'}>
            Spent XP: {charDetail.spent_xp}
          </Grid>
          <Grid item xs={4} textAlign={'center'}>
