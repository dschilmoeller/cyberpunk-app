...
export default function RulebookCyberware() {
  ...
  return (<>
    ...
    <Grid container spacing={1}>
      ...
      <Grid item xs={12}><Typography variant='p'>No matter how much effort cyberware owners put in, there is always <i>some</i> dissasociation with body warping equipment. This is reflected in the minimum humanity loss. Temporary humanity loss is variable, and can be much higher. Temporary humanity loss can be mitigated by spending experience or seeking professional counseling.</Typography></Grid>
    </Grid>
