      ...
      <Grid container padding={1} spacing={1}>
        ...
        <Grid item xs={12}>
          <Typography variant="p">
            Clothing has several distinct styles and levels of quality.
            Generally, this is more of a flavor situation, but there can be a
            couple benefits to looking good.
          </Typography>
        </Grid>

        <Grid item xs={12}>
          <Typography variant="p">
            At its most basic level, each item of clothing represents an outfit
            with a single stat - Quality. An outfit can be improved, pimped, or
            draped in drip to improve its quality rating, limited by the
            outfit's baseline quality. Improving an outfit's quality might be
            everything from accessorizing properly to replacing pieces with
            higher quality or more interesting bits. Outfits can be 'downgraded'
            as well as improved; lowering the quality represents pawning or
            selling one's clothes for a quick buck.
          </Typography>
        </Grid>

        <Grid item xs={12}>
          <Typography variant="p">
            Characters can have multiple outfits of varying styles, each of
            which can improved separately. The rules of fashion and gameplay
            balance only allow for wearing one at a time, however. Clothing of
            sufficient quality (5+) increases a character's Appearance attribute
            by 1. Clothing of maximum quality (10) provides a more powerful
            bonus.
          </Typography>
        </Grid>
        ...
        <Grid item xs={12}>
          <Typography variant="p">
            Lifestyle is a measure of how a character lives, as well as their
            access to certain resources and a general guide to how they live
            from day to day. It is divided into several areas, each with their
            own rank and cost.
          </Typography>
        </Grid>
        <Grid item xs={12}>
        ...
        <Grid item xs={12}>
          <Typography variant="p">
            Amenities: What the character's home offers in terms of utilities,
            recreation, etc.
          </Typography>
        </Grid>
        <Grid item xs={12}>
        ...
        <Grid item xs={12}>
          <Typography variant="p">
            Parking: Where characters can store their vehicles, and how many and
            securely they can do so.
          </Typography>
        </Grid>
        <Accordion
          disableGutters
          expanded={lifestyleAccordion === 'panel1'}
          onChange={handleLifestyleAccordionChange('panel1')}
        >
          <AccordionSummary
            expandIcon={<ExpandMoreIcon />}
            aria-controls="armor-content"
