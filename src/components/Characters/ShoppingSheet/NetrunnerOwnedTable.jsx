...
export default function NetrunnerOwnedTable() {
    ...
    function createCharNetrunnerGearData(attack, char_id, defense, description, equipped, name, netrunner_bridge_id, netrunner_master_id, perception, price, rez, slots, speed, type) {
        return { attack, char_id, defense, description, equipped, name, netrunner_bridge_id, netrunner_master_id, perception, price, rez, slots, speed, type }
    }

    const charNetrunnerRows = []
    for (let i = 0; i < charNetrunnerGear.length; i++) {
        charNetrunnerRows.push(createCharNetrunnerGearData(charNetrunnerGear[i].attack,
