...
export default function PharmaOwnedTable() {
    ...
    const sellOwnedGear = (item) => {
        ...
        dispatch({ type: 'SELL_ITEM', payload: { itemID: item.char_pharma_bridge_id, newBank, charID: charDetail.id, table: 'char_pharma_bridge', column: 'char_pharma_bridge_id' } })
    }
    ...
    function createCharOtherData(char_pharma_bridge_id, char_id, description, pharma_master_id, name, price) {
        return {
    ...
    for (let i = 0; i < charPharma.length; i++) {
        charOtherRows.push(createCharOtherData(charPharma[i].char_pharma_bridge_id,
            charPharma[i].char_id,
            charPharma[i].description,
            charPharma[i].pharma_master_id,
            charPharma[i].name,
            charPharma[i].price))
    }
