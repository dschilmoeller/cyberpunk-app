...
export default function ClothingEquippedTable() {
  ...
  const degradeClothing = (item) => {
    let newBank =
      charDetail.bank + Math.floor(priceMaker(item.quality, item.rank - 1) / 4);
                        ...
                        {row.quality === 0 ? (
                          <>
                            <TableCell align="center">
                              This outfit is busted.
                            </TableCell>
                            <TableCell align="center">
                              Can you even sell this for money?
                            </TableCell>
                          </>
                        ) : (
                          <></>
                          ...
                          <>
                            <TableCell align="center">
                              <Button
                                ...
                                color="success"
                                onClick={() => improveClothing(row)}
                              >
                                It's important to accessorize - {euroBuck}
                                {priceMaker(row.quality, row.rank + 1)}
                              </Button>
                            </TableCell>
                            <TableCell align="center">
                              <Button
                              ...
                              >
                                Hope you can give this to someone in need.
                              </Button>
                            </TableCell>
                          </>
                        ) : (
                          ...
                          <>
                            ...
                            <TableCell align="center">
                              <Button
                                ...
                                color="error"
                                onClick={() => degradeClothing(row)}
                              >
                                Marie Kondo this look - {euroBuck}
                                {Math.floor(
                                  priceMaker(row.quality, row.rank - 1) / 4
                                )}
                              </Button>
                            </TableCell>
                          </>
                          ...
                          <>
                            <TableCell align="center">
                              <Button
                                ...
                                onClick={() => improveClothing(row)}
                              >
                                Feeling cute, might buy another hat - {euroBuck}
                                {priceMaker(row.quality, row.rank + 1)}
                              </Button>
                            </TableCell>
                            <TableCell align="center">
                              <Button
                                ...
                                onClick={() => degradeClothing(row)}
                              >
                                I need to afford food again - {euroBuck}
                                {Math.floor(
                                  priceMaker(row.quality, row.rank - 1) / 4
                                )}
                              </Button>
