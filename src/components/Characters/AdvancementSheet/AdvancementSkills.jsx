  ...
  const skillSpendExp = (skillScore, skillName) => {
    ...
    if (increaseSkillCost <= availableExp) {
      ...
      dispatch({
        ...
        payload: {
          statName: skillName,
          newValue: skillScore + 1,
          newSpentXP: advancementDetails.spent_xp + increaseSkillCost,
          ...
          <>
                ...
                {SkillSet.streets.map((skill) => {
                  return (
                    <>
                      ...
                      <Grid item xs={5}>
                        <Item>
                          {skillDotReturn(advancementDetails[skill[0]])}
                        </Item>
                      </Grid>
                      <Grid item xs={4}>
                        {advancementDetails[skill[0]] < 5 ? (
                          <Item
                            ...
                            onClick={() =>
                              skillSpendExp(
                                advancementDetails[skill[0]],
                                'athletics'
                              )
                            }
                          >
                            Increase:{' '}
                            {skillExpReturn(advancementDetails[skill[0]])}
                          </Item>
                        ) : (
                          <Item>Maxed</Item>
                        )}
            ...
            {advancementDetails.is_paramedical ? (
              <>
                ...
                <Grid item xs={5}>
                  <Item>{skillDotReturn(advancementDetails.paramed)}</Item>
                </Grid>
                <Grid item xs={4}>
                  {advancementDetails.paramed < 5 ? (
                    <Item
                      ...
                      onClick={() =>
                        skillSpendExp(advancementDetails.paramed, 'paramed')
                      }
                    >
              ...
              <>
                ...
                <Grid item xs={5}>
                  <Item>{skillDotReturn(advancementDetails.first_aid)}</Item>
                </Grid>
                <Grid item xs={4}>
                  {advancementDetails.first_aid < 5 ? (
                    <Item
                      ...
                      onClick={() =>
                        skillSpendExp(advancementDetails.first_aid, 'first_aid')
                      }
                    >
