                ...
                <>
                    <Grid item xs={4}>
                        <Grid container>
                            ...
                            <Grid item xs={4}>{advancementDetails.athletics < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.athletics, 'athletics')}>Increase: {skillExpReturn(advancementDetails.athletics)}</Item> : <Item>Maxed</Item>}</Grid>
                            ...
                            <Grid item xs={4}>{advancementDetails.brawling < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.brawling, 'brawling')}>Increase: {skillExpReturn(advancementDetails.brawling)}</Item> : <Item>Maxed</Item>}</Grid>
                            ...
                            <Grid item xs={4}>{advancementDetails.concentration < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.concentration, 'concentration')}>Increase: {skillExpReturn(advancementDetails.concentration)}</Item> : <Item>Maxed</Item>}</Grid>
                            ...
                            <Grid item xs={4}>{advancementDetails.evasion < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.evasion, 'evasion')}>Increase: {skillExpReturn(advancementDetails.evasion)}</Item> : <Item>Maxed</Item>}</Grid>
                            ...
                            <Grid item xs={4}>{advancementDetails.fast_talk < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.fast_talk, 'fast_talk')}>Increase: {skillExpReturn(advancementDetails.fast_talk)}</Item> : <Item>Maxed</Item>}</Grid>
                            ...
                            <Grid item xs={4}>{advancementDetails.firearms < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.firearms, 'firearms')}>Increase: {skillExpReturn(advancementDetails.firearms)}</Item> : <Item>Maxed</Item>}</Grid>
                            ...
                            <Grid item xs={4}>{advancementDetails.legerdemain < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.legerdemain, 'legerdemain')}>Increase: {skillExpReturn(advancementDetails.legerdemain)}</Item> : <Item>Maxed</Item>}</Grid>
                            ...
                            <Grid item xs={4}>{advancementDetails.melee_weapons < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.melee_weapons, 'melee_weapons')}>Increase: {skillExpReturn(advancementDetails.melee_weapons)}</Item> : <Item>Maxed</Item>}</Grid>
                            ...
                            <Grid item xs={4}>{advancementDetails.perception < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.perception, 'perception')}>Increase: {skillExpReturn(advancementDetails.perception)}</Item> : <Item>Maxed</Item>}</Grid>
                            ...
                            <Grid item xs={4}>{advancementDetails.streetwise < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.streetwise, 'streetwise')}>Increase: {skillExpReturn(advancementDetails.streetwise)}</Item> : <Item>Maxed</Item>}</Grid>
                        </Grid>
                    </Grid>
                    ...
                    <Grid item xs={4}>
                        <Grid container>
                            ...
                            <Grid item xs={4}>{advancementDetails.demolitions < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.demolitions, 'demolitions')}>Increase: {skillExpReturn(advancementDetails.demolitions)}</Item> : <Item>Maxed</Item>}</Grid>
                            ...
                            <Grid item xs={4}>{advancementDetails.drive_land < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.drive_land, 'drive_land')}>Increase: {skillExpReturn(advancementDetails.drive_land)}</Item> : <Item>Maxed</Item>}</Grid>
                            ...
                            <Grid item xs={4}>{advancementDetails.drive_exotic < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.drive_exotic, 'drive_exotic')}>Increase: {skillExpReturn(advancementDetails.drive_exotic)}</Item> : <Item>Maxed</Item>}</Grid>
                            ...
                            <Grid item xs={4}>{advancementDetails.etiquette < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.etiquette, 'etiquette')}>Increase: {skillExpReturn(advancementDetails.etiquette)}</Item> : <Item>Maxed</Item>}</Grid>
                            ...
                            <Grid item xs={4}>{advancementDetails.exotic_weapons < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.exotic_weapons, 'exotic_weapons')}>Increase: {skillExpReturn(advancementDetails.exotic_weapons)}</Item> : <Item>Maxed</Item>}</Grid>
                            ...
                            <Grid item xs={4}>{advancementDetails.heavy_weapons < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.heavy_weapons, 'heavy_weapons')}>Increase: {skillExpReturn(advancementDetails.heavy_weapons)}</Item> : <Item>Maxed</Item>}</Grid>
                            ...
                            <Grid item xs={4}>{advancementDetails.performance < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.performance, 'performance')}>Increase: {skillExpReturn(advancementDetails.performance)}</Item> : <Item>Maxed</Item>}</Grid>
                            ...
                            <Grid item xs={4}>{advancementDetails.stealth < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.stealth, 'stealth')}>Increase: {skillExpReturn(advancementDetails.stealth)}</Item> : <Item>Maxed</Item>}</Grid>
                            ...
                            <Grid item xs={4}>{advancementDetails.survival < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.survival, 'survival')}>Increase: {skillExpReturn(advancementDetails.survival)}</Item> : <Item>Maxed</Item>}</Grid>
                            ...
                            <Grid item xs={4}>{advancementDetails.tracking < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.tracking, 'tracking')}>Increase: {skillExpReturn(advancementDetails.tracking)}</Item> : <Item>Maxed</Item>}</Grid>
                    ...
                    <Grid item xs={4}>
                        <Grid container>
                            ...
                            <Grid item xs={4}>{advancementDetails.business < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.business, 'business')}>Increase: {skillExpReturn(advancementDetails.business)}</Item> : <Item>Maxed</Item>}</Grid>
                            ...
                            <Grid item xs={4}>{advancementDetails.cryptography < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.cryptography, 'cryptography')}>Increase: {skillExpReturn(advancementDetails.cryptography)}</Item> : <Item>Maxed</Item>}</Grid>
                            ...
                            <Grid item xs={4}>{advancementDetails.cyber_tech < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.cyber_tech, 'cyber_tech')}>Increase: {skillExpReturn(advancementDetails.cyber_tech)}</Item> : <Item>Maxed</Item>}</Grid>
                            ...
                            <Grid item xs={4}>{advancementDetails.investigation < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.investigation, 'investigation')}>Increase: {skillExpReturn(advancementDetails.investigation)}</Item> : <Item>Maxed</Item>}</Grid>
                            ...
                            <Grid item xs={4}>{advancementDetails.gambling < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.gambling, 'gambling')}>Increase: {skillExpReturn(advancementDetails.gambling)}</Item> : <Item>Maxed</Item>}</Grid>
                            ...
                            <Grid item xs={4}>{advancementDetails.language < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.language, 'language')}>Increase: {skillExpReturn(advancementDetails.language)}</Item> : <Item>Maxed</Item>}</Grid>
                            ...
                            <Grid item xs={4}>{advancementDetails.military_tech < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.military_tech, 'military_tech')}>Increase: {skillExpReturn(advancementDetails.military_tech)}</Item> : <Item>Maxed</Item>}</Grid>
                            ...
                            <Grid item xs={4}>{advancementDetails.science < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.science, 'science')}>Increase: {skillExpReturn(advancementDetails.science)}</Item> : <Item>Maxed</Item>}</Grid>
                            ...
                            <Grid item xs={4}>{advancementDetails.vehicle_tech < 5 ? <Item sx={{
                                cursor: 'pointer', '&:hover': {
                                    backgroundColor: '#fff',
                                    color: '#000',
                                }
                            }} onClick={() => skillSpendExp(advancementDetails.vehicle_tech, 'vehicle_tech')}>Increase: {skillExpReturn(advancementDetails.vehicle_tech)}</Item> : <Item>Maxed</Item>}</Grid>
                        </Grid>
                    </Grid>
                </>
            ) : <>
