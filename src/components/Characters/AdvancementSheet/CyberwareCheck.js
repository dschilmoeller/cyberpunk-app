export default function CyberwareCheck(incomingCyber, charCyberware) {
  ...
  if (algernonic.test(incomingCyber.name) === true) {
    for (let i = 0; i < charCyberware.length; i++) {
      if (
        algernonic.test(charCyberware[i].name) == true &&
    ...
    incomingCyber.name === 'Toxin Binders' ||
    ...
    incomingCyber.name === 'Platelet Booster' ||
    ...
    for (let i = 0; i < charCyberware.length; i++) {
      if (
        charCyberware[i].cyberware_master_id ===
          incomingCyber.cyberware_master_id &&
        charCyberware[i].equipped === true
      ) {
        if (
