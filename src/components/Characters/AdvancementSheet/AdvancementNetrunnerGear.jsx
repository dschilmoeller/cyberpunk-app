...
export default function AdvancementNetrunnerGear() {
  const charDetailCyberdeckSlots = useSelector(
    (store) => store.advancementDetail.cyberdeck_slots
  );
  ...
  return (
    <>
      ...
      <Grid container>
        <Grid item xs={12}>
          <Item>Available Slots: {netrunnerSlots}</Item>
        </Grid>
      </Grid>
                ...
                return (
                  <TableRow hover key={i}>
                    ...
                    <TableCell align="center">
                      <Button onClick={() => unequipNetrunnerGear(item)}>
                        Unequip
                      </Button>
                    </TableCell>
                  </TableRow>
                  ...
                  if (item.type === 'deck' && item.equipped === false) {
                    return (
                      <TableRow hover key={i}>
                        ...
                        <TableCell
                          align="center"
                          onClick={() => equipNetrunnerGear(item)}
                        >
                          <Button>Equip</Button>
                        </TableCell>
                      </TableRow>
                  ...
                  if (item.type === 'software' && item.equipped === false) {
                    return (
                      <TableRow hover key={i}>
                        ...
                        <TableCell align="center">
                          <Button onClick={() => equipNetrunnerGear(item)}>
                            Equip
                          </Button>
                        </TableCell>
                      </TableRow>
