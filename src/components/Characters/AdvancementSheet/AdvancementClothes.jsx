...
export default function AdvancementClothes() {
  ...
  const characterClothes = useSelector(
    (store) => store.advancementGear.clothes
  );
  ...
  return (
    <>
      <h1>
        Current Clothing - Outfits can be upgraded in the{' '}
        <Button
          variant="contained"
      ...
      <Grid container>
        <Grid item xs={12} paddingLeft={2} paddingRight={2}>
          <h4>
            Clothes of Rank 5+ give you a +1 bonus to Appearance Attribute.
            Clothes of Rank 10 give a bonus to Appearance and Cool - there's
            confidence that comes with that amount of style.
          </h4>
        </Grid>
      </Grid>
