...
export default function AdvancementCyberware() {
  ...
  const charCyberwareSlots = useSelector(
    (store) => store.advancementGear.cyberwareSlots
  );
  ...
  const cyberwareEquippedCheck = (incomingCyber) => {
    // check for humanity:
    if (
      charDetails.temp_humanity_loss +
        charDetails.perm_humanity_loss +
        incomingCyber.humanity_loss_min >
      40
    ) {
      ...
      if (status.equipStatus === false) {
        ...
        setToastText(
          `Incompatible cyberware ${status.equippedItemName} detected`
        );
        setShowSnackbar(true);
      }
    }
    ...
    switch (incomingCyber.type) {
        ...
        if (fashionSlots > 0) {
          ...
          dispatch({
            ...
            payload: {
              ...
              tablePrimaryKey: 'owned_cyberware_id',
              tableID: incomingCyber.owned_cyberware_id,
              equipStatus: true,
              charCyberwareSlots,
              humanity: {
                currentPermLoss: charDetails.perm_humanity_loss,
                currentTempLoss: charDetails.temp_humanity_loss,
              },
            },
          });
          break;
      ...
      case 'neuralware':
        ...
        if (incomingCyber.name === 'Basic Neural Link') {
          ...
          setToastText(
            "Not enough slots - make sure you have a neural link installed and it isn't full!"
          );
          setShowSnackbar(true);
          dispatch({ type: 'SET_ADVANCEMENT_LOAD_STATUS', payload: false });
          break;
      ...
      case 'cyberoptics':
        ...
        if (incomingCyber.name === 'Basic Cybereyes') {
          ...
          setToastText(
            "Not enough slots - make sure you have cybereyes and they aren't already full!"
          );
          setShowSnackbar(true);
          dispatch({ type: 'SET_ADVANCEMENT_LOAD_STATUS', payload: false });
          break;
      ...
      case 'cyberaudio':
        ...
        if (incomingCyber.name === 'Basic Cyberaudio Suite') {
          ...
          setToastText(
            "Not enough slots - make sure you have a cyberaudio suite installed and that it isn't full!"
          );
          setShowSnackbar(true);
          dispatch({ type: 'SET_ADVANCEMENT_LOAD_STATUS', payload: false });
          break;
      ...
      case 'externalware':
        ...
        if (externalwareSlots > 0) {
          ...
          setToastText(
            `Remove your current externalware to equip a different piece!`
          );
          setShowSnackbar(true);
          dispatch({ type: 'SET_ADVANCEMENT_LOAD_STATUS', payload: false });
          break;
        ...
        if (
          ...
          if (incomingCyber.name === 'Cyberarm - Right') {
            ...
            for (let i = 0; i < charCyberware.length; i++) {
              if (
                charCyberware[i].name === 'Artificial Shoulder Mount' &&
          ...
          setToastText(
            "Not enough slots - make sure you have a cyberarm or two and they aren't already full!"
          );
          setShowSnackbar(true);
          dispatch({ type: 'SET_ADVANCEMENT_LOAD_STATUS', payload: false });
          break;
      ...
      case 'cyberleg':
        ...
        if (
          ...
          setToastText(
            "Not enough slots - make sure you have a cyberleg or two and they aren't already full!"
          );
          setShowSnackbar(true);
          dispatch({ type: 'SET_ADVANCEMENT_LOAD_STATUS', payload: false });
          break;
  ...
  const unequipCyber = (incomingCyber) => {
    switch (incomingCyber.type) {
      ...
      case 'neuralware':
        if (
          charCyberwareSlots.neuralware_slots === 5 ||
          incomingCyber.name != 'Basic Neural Link'
        ) {
          dispatch({ type: 'SET_ADVANCEMENT_LOAD_STATUS', payload: true });
          dispatch({
            type: 'CHANGE_GEAR_EQUIP_STATUS',
      ...
      case 'cyberoptics':
        dispatch({ type: 'SET_ADVANCEMENT_LOAD_STATUS', payload: true });
        if (
          charCyberwareSlots.cyberoptic_slots === 3 ||
          incomingCyber.name != 'Basic Cybereyes'
        ) {
          dispatch({
            type: 'CHANGE_GEAR_EQUIP_STATUS',
            payload: {
      ...
      case 'cyberaudio':
        dispatch({ type: 'SET_ADVANCEMENT_LOAD_STATUS', payload: true });
        if (
          charCyberwareSlots.cyberaudio_slots === 3 ||
          incomingCyber.name != 'Basic Cyberaudio Suite'
        ) {
          dispatch({
            type: 'CHANGE_GEAR_EQUIP_STATUS',
            payload: {
          ...
          <TableBody>
            <TableRow hover>
              <TableCell align="center">
                Permanent Humanity Loss: {charDetails.perm_humanity_loss}
              </TableCell>
              <TableCell align="center">
                Temporary Humanity Loss: {charDetails.temp_humanity_loss}
              </TableCell>
              {charDetails.perm_humanity_loss + charDetails.temp_humanity_loss >
              39 ? (
                <TableCell
            ...
            {selectedList === 'fashionware' ? (
              <TableRow hover>
                <TableCell align="center">
                  Fashionware Requirements: None
                </TableCell>
                <TableCell></TableCell>
                <TableCell align="center">
                  Available Fashionware Slots: {fashionSlots}
                </TableCell>
              </TableRow>
            ) : (
              <></>
            ...
            {selectedList === 'cyberaudio' ? (
              <TableRow hover>
                <TableCell align="center">
                  Cyberaudio Requirements: Cyber Audio Suite
                </TableCell>
                <TableCell></TableCell>
                <TableCell align="center">
                  Available Cyberaudio Slots: {cyberaudioSlots}
                </TableCell>
              </TableRow>
            ) : (
              <></>
            ...
            {selectedList === 'neuralware' ? (
              <TableRow hover>
                <TableCell align="center">
                  Neuralware Requirements: Neural Link
                </TableCell>
                <TableCell></TableCell>
                <TableCell align="center">
                  Available Neuralware Slots: {neuralSlots}
                </TableCell>
              </TableRow>
            ) : (
              <></>
            ...
            {selectedList === 'cyberoptics' ? (
              <TableRow hover>
                <TableCell align="center">
                  Optics Requirements: Cybereyes
                </TableCell>
                <TableCell></TableCell>
                <TableCell align="center">
                  Available Cyberoptic Slots: {opticSlots}
                </TableCell>
              </TableRow>
            ) : (
              <></>
            ...
            {selectedList === 'internalware' ? (
              <TableRow hover>
                <TableCell align="center">
                  Internalware Requirements: None
                </TableCell>
                <TableCell></TableCell>
                <TableCell align="center">
                  Available Internalware Slots: {internalwareSlots}
                </TableCell>
              </TableRow>
            ) : (
              <></>
            ...
            {selectedList === 'externalware' ? (
              <TableRow hover>
                <TableCell align="center">
                  Externalware Requirements: None
                </TableCell>
                <TableCell></TableCell>
                <TableCell align="center">
                  Available Externalware Slots: {externalwareSlots}
                </TableCell>
              </TableRow>
            ) : (
              <></>
            ...
            {selectedList === 'cyberarm' ? (
              <TableRow hover>
                <TableCell align="center">
                  Cyberarm Requirements: Cyberarm
                </TableCell>
                <TableCell></TableCell>
                <TableCell align="center">
                  Available Cyberarm Slots: {cyberarmSlots}
                </TableCell>
              </TableRow>
            ) : (
              <></>
            ...
            {selectedList === 'cyberleg' ? (
              <TableRow hover>
                <TableCell align="center">
                  Cyberleg Requirements: Cyberleg
                </TableCell>
                <TableCell></TableCell>
                <TableCell align="center">
                  Available Cyberleg Slots: {cyberlegSlots}
                </TableCell>
              </TableRow>
            ) : (
              <></>
                    ...
                    {item.type === selectedList ? (
                      <TableRow hover key={i}>
                        ...
                        <TableCell align="center">
                          <Button
                            variant={
                              loadStatus === true ? 'disabled' : 'contained'
                            }
                            color="secondary"
                            onClick={() => unequipCyber(item)}
                          >
                            Unequip
                          </Button>
                        </TableCell>
                      ...
                      <TableRow hover key={i}>
                        ...
                        <TableCell align="center">
                          <Button
                            ...
                            color="info"
                            onClick={() => cyberwareEquippedCheck(item)}
                          >
                            Equip
                          </Button>
                        </TableCell>
