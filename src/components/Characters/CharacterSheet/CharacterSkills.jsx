...
function CharacterSkills(charDetailProp) {
  ...
  const fulldot = (
    <CircleIcon
      sx={{
        fontSize: { xs: '1.25rem', sm: '1.25rem', md: '1.25rem', lg: '1.5rem' },
      }}
    />
  );
  const emptydot = (
  ...
  const dotReturn = (skill) => {
    ...
    for (j; j <= 4; j++) {
      returnedDots.push(
        <React.Fragment key={j + 10}>{emptydot}</React.Fragment>
      );
    }
    return returnedDots;
  };
    ...
    <>
      ...
      <Grid item xs={4}>
        <Grid container>
          ...
          <Grid item xs={8}>
            <Item>{dotReturn(concentration)}</Item>
          </Grid>
          ...
          <Grid item xs={8}>
            <Item>{dotReturn(legerdemain)}</Item>
          </Grid>
          ...
          <Grid item xs={8}>
            <Item>{dotReturn(meleeWeapons)}</Item>
          </Grid>
          ...
          <Grid item xs={8}>
            <Item>{dotReturn(perception)}</Item>
          </Grid>
          ...
          <Grid item xs={8}>
            <Item>{dotReturn(streetwise)}</Item>
          </Grid>
        </Grid>
      </Grid>
      ...
      <Grid item xs={4}>
        <Grid container>
          ...
          <Grid item xs={8}>
            <Item>{dotReturn(demolitions)}</Item>
          </Grid>
          ...
          <Grid item xs={8}>
            <Item>{dotReturn(driveExotic)}</Item>
          </Grid>
          ...
          <Grid item xs={8}>
            <Item>{dotReturn(exoticWeapons)}</Item>
          </Grid>
          ...
          <Grid item xs={8}>
            <Item>{dotReturn(heavyWeapons)}</Item>
          </Grid>
          ...
          <Grid item xs={8}>
            <Item>{dotReturn(performance)}</Item>
          </Grid>
      ...
      <Grid item xs={4}>
        <Grid container>
          ...
          <Grid item xs={8}>
            <Item>{dotReturn(cryptography)}</Item>
          </Grid>
          ...
          <Grid item xs={8}>
            <Item>{dotReturn(investigation)}</Item>
          </Grid>
          ...
          <Grid item xs={8}>
            <Item>{dotReturn(vehicleTech)}</Item>
          </Grid>
        </Grid>
      </Grid>
    </>
