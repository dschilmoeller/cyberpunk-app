...
export default function CreationGear() {
  ...
  const charNetrunnerGear = useSelector(
    (store) => store.characterCreation.netrunnerGear
  );
  ...
  const purchaseNetrunnerGear = (price, index) => {
    if (bank >= price) {
      setBank(bank - price);
      dispatch({
        type: 'CREATION_BUY_NETRUNNER_GEAR',
        payload: index,
        newBank: bank - price,
      });
    } else {
  ...
  const sellNetrunnerGear = (price, index) => {
    setBank(bank + price);
    dispatch({
      type: 'CREATION_SELL_NETRUNNER_GEAR',
      payload: index,
      newBank: bank + price,
    });
  };
  ...
  return (
    <>
      ...
      <Grid container display={'flex'} justifyContent={'center'} spacing={1}>
        ...
        <Grid item xs={12}>
          <Item sx={{ height: 1 }}>
            Remember: You can't take it with you. You'll have a different pool
            of money for cyberware next!
          </Item>
        </Grid>
      </Grid>
      ...
      <Grid container>
        <Tabs value={value} onChange={handleChange} indicatorColor="secondary">
          ...
          {charDetail.netrunner > 0 ? (
            <Tab value="Netrunner" label="Netrunner Equipment" />
          ) : (
            <Tab value="Netrunner" label="Netrunner Equipment" disabled />
          )}
        </Tabs>
      </Grid>
      ...
      {value === 'Armor' ? (
        <>
          ...
          >
            ...
            <Grid item xs={12}>
              <Item>
                Note: Armor must be equipped from the advancement sheet.
              </Item>
            </Grid>
          </Grid>
              ...
              <TableBody>
                {charArmor.map((item, i) => (
                  <TableRow hover key={i}>
                    ...
                    <TableCell align="right">
                      {euroBuck}
                      {armor[item].price.toLocaleString('en-US')}
                    </TableCell>
                    <TableCell align="left">
                      <Button onClick={() => sellArmor(armor[item].price, i)}>
                        Return
                      </Button>
                    </TableCell>
                  </TableRow>
                ...
                {charShield.map((item, i) => (
                  <TableRow hover key={i}>
                    ...
                    <TableCell align="right">
                      {euroBuck}
                      {shield[item].price.toLocaleString('en-US')}
                    </TableCell>
                    <TableCell align="left">
                      <Button onClick={() => sellShield(shield[item].price, i)}>
                        Return
                      </Button>
                    </TableCell>
                  </TableRow>
                  ...
                  if (row.price < 5000) {
                    return (
                      <TableRow hover key={row.name}>
                        ...
                        <TableCell align="left">
                          <Button onClick={() => purchaseArmor(row.price, i)}>
                            Purchase
                          </Button>
                        </TableCell>
                      </TableRow>
                  ...
                  if (row.price < 5000) {
                    return (
                      <TableRow hover key={row.name}>
                        ...
                        <TableCell align="left">
                          <Button onClick={() => purchaseShield(row.price, i)}>
                            Purchase
                          </Button>
                        </TableCell>
                      </TableRow>
      ...
      {value === 'Weapons' ? (
        <>
          ...
          >
            <Grid item xs={12}>
              <Item>My Weapons</Item>
            </Grid>
            <Grid item xs={12}>
              <Item>Note: Weapons are automatically equipped.</Item>
            </Grid>
          </Grid>
              ...
              <TableBody>
                {charWeapons.map((item, i) => (
                  <TableRow hover key={i}>
                    ...
                    <TableCell align="right">
                      ${weapons[item].price.toLocaleString('en-US')}
                    </TableCell>
                    <TableCell align="left">
                      <Button
                        onClick={() => sellWeapon(weapons[item].price, i)}
                      >
                        Return
                      </Button>
                    </TableCell>
                  ...
                  if (row.price < 5000 && row.is_treasure != true) {
                    return (
                      <TableRow hover key={i}>
                        ...
                        <TableCell align="center">
                          {row.dmg_type === 'melee' || row.dmg_type === 'bow'
                            ? `Str + ${row.damage}`
                            : `${row.damage}`}
                        </TableCell>
                        <TableCell align="center">
                        ...
                        <TableCell align="left">
                          <Button onClick={() => purchaseWeapon(row.price, i)}>
                            Purchase
                          </Button>
                        </TableCell>
                      </TableRow>
              ...
              <TableBody>
                {charGrenades.map((item, i) => (
                  <TableRow hover key={i}>
                    ...
                    <TableCell align="right">
                      ${grenades[item].price.toLocaleString('en-US')}
                    </TableCell>
                    <TableCell align="left">
                      <Button
                        onClick={() => sellGrenade(grenades[item].price, i)}
                      >
                        Return
                      </Button>
                    </TableCell>
                  ...
                  if (row.price < 5000 && row.is_treasure != true) {
                    return (
                      <TableRow hover key={i}>
                        ...
                        <TableCell align="left">
                          <Button onClick={() => purchaseGrenade(row.price, i)}>
                            Purchase
                          </Button>
                        </TableCell>
                      </TableRow>
              ...
              <TableBody>
                {charGear.map((item, i) => (
                  <TableRow hover key={i}>
                    ...
                    <TableCell align="right">
                      {euroBuck}
                      {miscGear[item].price.toLocaleString('en-US')}
                    </TableCell>
                    <TableCell align="left">
                      <Button onClick={() => sellGear(miscGear[item].price, i)}>
                        Return
                      </Button>
                    </TableCell>
                  </TableRow>
              ...
              <TableBody>
                {miscGear.map((row, i) => (
                  <TableRow hover key={row.name}>
                    ...
                    <TableCell align="left">
                      <Button onClick={() => purchaseGear(row.price, i)}>
                        Purchase
                      </Button>
                    </TableCell>
                  </TableRow>
        ...
        <>
          <Grid container padding={2}>
            ...
            <Grid item xs={12}>
              ...
              <h4>
                Note: Equipment must be equipped from the advancement sheet.
              </h4>
            </Grid>
          </Grid>
          <Grid container padding={2}>
                ...
                <TableBody>
                  {
                    charNetrunnerGear.map((item, i) => {
                      return (
                        <TableRow hover key={i}>
                          <TableCell align="left">
                            {netrunnerGear[item].name}{' '}
                          </TableCell>
                          <TableCell align="left">
                            {netrunnerGear[item].description}
                          </TableCell>
                          <TableCell align="center">
                            {euroBuck}
                            {netrunnerGear[item].price.toLocaleString('en-US')}
                          </TableCell>
                          <TableCell align="center">
                            {netrunnerGear[item].slots}
                          </TableCell>
                          <TableCell align="center">
                            <Button
                              onClick={() =>
                                sellNetrunnerGear(netrunnerGear[item].price, i)
                              }
                            >
                              Return
                            </Button>
                        ...
                        return (
                          <TableRow hover key={row.name}>
                            ...
                            <TableCell align="center">
                              <Button
                                onClick={() =>
                                  purchaseNetrunnerGear(row.price, i)
                                }
                              >
                                Purchase
                              </Button>
