...
export default function CreationReview() {
  ...
  const saveCharacter = () => {
    ...
    // temp fix to insert 'no shield' into array
    shield.map((item) => {
      if (item.name == 'No Shield') {
        shield_master_array.push(item.shield_master_id);
      }
    });
    ...
    for (let i = 0; i < charDetail.grenades.length; i++) {
      grenade_master_array.push(
        grenades[charDetail.grenades[i]].grenade_master_id
      );
    }
    ...
    for (let i = 0; i < charDetail.gear.length; i++) {
      misc_gear_master_array.push(
        miscGear[charDetail.gear[i]].misc_gear_master_id
      );
    }
    ...
    for (let i = 0; i < charDetail.netrunnerGear.length; i++) {
      netrunner_gear_master_array.push(
        netrunnerMaster[charDetail.netrunnerGear[i]].netrunner_master_id
      );
    }
    ...
    for (let i = 0; i < charDetail.cyberware.length; i++) {
      cyberware_master_array.push(
        cyberware[charDetail.cyberware[i]].cyberware_master_id
      );
    }
    ...
    <>
      <Box sx={{ flexGrow: 1 }}>
        <Grid container paddingLeft={3} paddingBottom={3} paddingRight={3}>
          ...
          <Grid item xs={12}>
            <Item>
              <Button fullWidth onClick={() => saveCharacter()}>
                Save Character
              </Button>
            </Item>
          </Grid>
            ...
            <>
              ...
              <Grid item xs={4}>
                <Grid container>
                  ...
                  <Grid item xs={8}>
                    <Item>{attDotReturn(strengthAtt)} </Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item>{attDotReturn(bodyAtt)}</Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item>{attDotReturn(reflexesAtt)}</Item>
                  </Grid>

                  <Grid item xs={4}>
                    <Item>
                      <AttributesDialog prop={'Move'} />
                    </Item>
                  </Grid>
                  <Grid item xs={8}>
                    <Item>{attDotReturn(moveatt)}</Item>
                  </Grid>
                </Grid>
              </Grid>
              ...
              <Grid item xs={4}>
                <Grid container>
                  ...
                  <Grid item xs={8}>
                    <Item> {attDotReturn(appearanceAtt)} </Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item> {attDotReturn(coolAtt)} </Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item> {attDotReturn(streetCredAtt)} </Item>
                  </Grid>
                </Grid>
              </Grid>
              ...
              <Grid item xs={4}>
                <Grid container>
                  ...
                  <Grid item xs={8}>
                    <Item> {attDotReturn(intelligenceAtt)} </Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item> {attDotReturn(willpowerAtt)} </Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item> {attDotReturn(techniqueAtt)} </Item>
                  </Grid>
                </Grid>
              </Grid>
              ...
              <Grid item xs={4}>
                <Grid container>
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(athletics)}</Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(brawling)}</Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(concentration)}</Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(evasion)}</Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(fastTalk)}</Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(firearms)}</Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(legerdemain)}</Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(meleeWeapons)}</Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(perception)}</Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(streetwise)}</Item>
                  </Grid>
                </Grid>
              </Grid>
              ...
              <Grid item xs={4}>
                <Grid container>
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(demolitions)}</Item>
                  </Grid>

                  <Grid item xs={4}>
                    <Item>
                      <SkillsDialog prop={'Drive Land'} />
                    </Item>
                  </Grid>
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(driveLand)}</Item>
                  </Grid>

                  <Grid item xs={4}>
                    <Item>
                      <SkillsDialog prop={'Drive Exotic'} />
                    </Item>
                  </Grid>
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(driveExotic)}</Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(etiquette)}</Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(exoticWeapons)}</Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(heavyWeapons)}</Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(performance)}</Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(stealth)}</Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(survival)}</Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(tracking)}</Item>
                  </Grid>
                </Grid>
              </Grid>
              ...
              <Grid item xs={4}>
                <Grid container>
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(business)}</Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(cryptography)}</Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(cyberTech)}</Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(investigation)}</Item>
                  </Grid>
                  ...
                  {isParamedical === true ? (
                    <>
                      ...
                      <Grid item xs={8}>
                        <Item>{skillDotReturn(paramedic)}</Item>
                      </Grid>
                    </>
                  ) : (
                    <>
                      ...
                      <Grid item xs={8}>
                        <Item>{skillDotReturn(firstAid)}</Item>
                      </Grid>
                    </>
                  )}
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(gambling)}</Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(language)}</Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(militaryTech)}</Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(science)}</Item>
                  </Grid>
                  ...
                  <Grid item xs={8}>
                    <Item>{skillDotReturn(vehicleTech)}</Item>
                  </Grid>
                </Grid>
              </Grid>
              ...
              <Grid container spacing={1} paddingTop={1} paddingBottom={1}>
                <Grid item xs={12}>
                  <Item>
                    ...
                    >
                      Role Abilities - click to return to Role selection
                    </Button>
                  </Item>
                </Grid>
                ...
                {rockerboy != '' ? (
                  <>
                    <Grid item xs={4.5}>
                      <Item>
                        <RoleAbilitiesDialog prop={'Rockerboy'} />
                      </Item>
                    </Grid>
                    <Grid item xs={7.5}>
                ...
                {netrunner != '' ? (
                  <>
                    <Grid item xs={4.5}>
                      <Item>
                        <RoleAbilitiesDialog prop={'Netrunner'} />
                      </Item>
                    </Grid>
                    <Grid item xs={7.5}>
                ...
                {nomad != '' ? (
                  <>
                    <Grid item xs={4.5}>
                      <Item>
                        <RoleAbilitiesDialog prop={'Nomad'} />
                      </Item>
                    </Grid>
                    <Grid item xs={7.5}>
                ...
                {media != '' ? (
                  <>
                    <Grid item xs={4.5}>
                      <Item>
                        <RoleAbilitiesDialog prop={'Media'} />
                      </Item>
                    </Grid>
                    <Grid item xs={7.5}>
                ...
                {medtech != '' ? (
                  <>
                    <Grid item xs={4.5}>
                      <Item>
                        <RoleAbilitiesDialog prop={'Medtech'} />
                      </Item>
                    </Grid>
                    <Grid item xs={7.5}>
                    ...
                    <Grid item xs={4.5}>
                      <Item>
                        <RoleAbilitiesDialog prop={'Surgery'} />
                      </Item>
                    </Grid>
                    <Grid item xs={7.5}>
                    ...
                    <Grid item xs={4.5}>
                      <Item>
                        <RoleAbilitiesDialog prop={'Pharmaceuticals'} />
                      </Item>
                    </Grid>
                    <Grid item xs={7.5}>
                    ...
                    <Grid item xs={4.5}>
                      <Item>
                        <RoleAbilitiesDialog prop={'Cryogenics'} />
                      </Item>
                    </Grid>
                    <Grid item xs={7.5}>
                ...
                {maker != '' ? (
                  <>
                    <Grid item xs={4.5}>
                      <Item>
                        <RoleAbilitiesDialog prop={'Maker'} />
                      </Item>
                    </Grid>
                    <Grid item xs={7.5}>
                    ...
                    <Grid item xs={4.5}>
                      <Item>
                        <RoleAbilitiesDialog prop={'Field Expertise'} />
                      </Item>
                    </Grid>
                    <Grid item xs={7.5}>
                    ...
                    <Grid item xs={4.5}>
                      <Item>
                        <RoleAbilitiesDialog prop={'Upgrade Expertise'} />
                      </Item>
                    </Grid>
                    <Grid item xs={7.5}>
                    ...
                    <Grid item xs={4.5}>
                      <Item>
                        <RoleAbilitiesDialog prop={'Fabrication'} />
                      </Item>
                    </Grid>
                    <Grid item xs={7.5}>
                    ...
                    <Grid item xs={4.5}>
                      <Item>
                        <RoleAbilitiesDialog prop={'Invention'} />
                      </Item>
                    </Grid>
                    <Grid item xs={7.5}>
                    ...
                    <TableBody>
                      {charDetail.weapons.map((item, i) => (
                        <TableRow hover key={i}>
                          ...
                          <TableCell align="center">
                            {weapons[item].dmg_type === 'melee' ||
                            weapons[item].dmg_type === 'bow'
                              ? `Str + ${weapons[item].damage}`
                              : `${weapons[item].damage}`}
                          </TableCell>
                          <TableCell align="center">
                            {weapons[item].dmg_type === 'bow'
                              ? `Str * ${weapons[item].range}`
                              : `${weapons[item].range}`}
                          </TableCell>
                          <TableCell align="center">
                            {weapons[item].rof}
                          ...
                          <TableCell align="center">
                            {weapons[item].max_clip}
                          </TableCell>
                          <TableCell align="center">
                            {weapons[item].hands}
                          </TableCell>
                          <TableCell align="center">
                            {weapons[item].concealable ? 'Yes' : 'No'}
                          </TableCell>
                          <TableCell align="center">
                            {weapons[item].price}$
                          </TableCell>
                      ...
                      >
                        ...
                        <TableBody>
                          {charDetail.netrunnerGear.map((item, i) => (
                            <TableRow hover key={i}>
                              <TableCell align="left">
                                {netrunnerMaster[item].name}
                              </TableCell>
                              <TableCell align="left">
                                {netrunnerMaster[item].description}
                              </TableCell>
                              <TableCell align="center">
                                {netrunnerMaster[item].price}$
                              </TableCell>
                            </TableRow>
                          ))}
                        </TableBody>
                    ...
                    <TableBody>
                      {charDetail.cyberware.map((item, i) => (
                        <TableRow hover key={i}>
                          ...
                          <TableCell align="left">
                            {Math.floor(cyberware[item].humanity_loss_max / 2)}
                          </TableCell>
                          <TableCell align="right">
                            {cyberware[item].price}$
                          </TableCell>
                        </TableRow>
                      ))}
                    </TableBody>
