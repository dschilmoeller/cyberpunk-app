...
function CreationRoleAbilities() {
  ...
  const [availableMedSkillPoints, setAvailableMedSkillPoints] = useState(
    charDetail.availableMedSkillPoints
  );
  const [availableMakerSkillPoints, setAvailableMakerSkillPoints] = useState(
    charDetail.availableMakerSkillPoints
  );
  ...
  return (
    <>
      ...
      <Grid container display={'flex'} justifyContent={'center'} spacing={1}>
        <Grid item xs={12}>
          <Item sx={{ height: 1 }}>
            <Typography variant="h4">Select Role</Typography>
          </Item>
        </Grid>
        <Grid item xs={12}>
          <Item sx={{ height: 1 }}>
            Roles are the niche Edgerunners occupy, and grant special abilities.
            Click the name to find out more!
          </Item>
        </Grid>
        <Grid item xs={12}>
          <Item sx={{ height: 1 }}>
            Roles selected during creation start with 2 ranks, and represent the
            specialization your character has chosen up to date, as well as
            their primary means of making a living on a day to day basis.
          </Item>
        </Grid>
        <Grid item xs={12}>
          <Item sx={{ height: 1 }}>
            Note that Medtech and Maker roles have special skills associated
            with them - you'll have to make some additional selections.
          </Item>
        </Grid>
      </Grid>
      ...
      <Grid container spacing={1} padding={2}>
        <Grid item xs={12}>
          <Item sx={{ fontSize: '1.8em', padding: 0 }}>Role Abilities</Item>
        </Grid>
        {roleSelection === 'Rockerboy' ? (
          <>
            <Grid item xs={12}>
              <Item sx={{ backgroundColor: '#607d8b' }}>
                ROCKERBOY SELECTED
              </Item>
            </Grid>
          </>
        ...
        {roleSelection === 'Solo' ? (
          <>
            <Grid item xs={12}>
              <Item sx={{ backgroundColor: '#607d8b' }}>SOLO SELECTED</Item>
            </Grid>
          </>
        ) : (
          <>
        ...
        {roleSelection === 'Nomad' ? (
          <>
            <Grid item xs={12}>
              <Item sx={{ backgroundColor: '#607d8b' }}>NOMAD SELECTED</Item>
            </Grid>
          </>
        ) : (
          <>
        ...
        {roleSelection === 'Media' ? (
          <>
            <Grid item xs={12}>
              <Item sx={{ backgroundColor: '#607d8b' }}>MEDIA SELECTED</Item>
            </Grid>
          </>
        ) : (
          <>
        ...
        {roleSelection === 'Medtech' ? (
          <>
            <Grid item xs={12}>
              <Item sx={{ backgroundColor: '#607d8b' }}>MEDTECH SELECTED</Item>
            </Grid>
          </>
        ) : (
          <>
        ...
        {roleSelection === 'Maker' ? (
          <>
            <Grid item xs={12}>
              <Item sx={{ backgroundColor: '#607d8b' }}>MAKER SELECTED</Item>
            </Grid>
          </>
        ) : (
          <>
      ...
      <Grid container spacing={1} padding={2}>
        {roleSelection === 'Medtech' ? (
          <>
            <Grid item xs={12}>
              <Item sx={{ fontSize: '1.8em', padding: 0 }}>Special Skills</Item>
            </Grid>
            <Grid item xs={12}>
              <Item>
                <h3>Points Available: {availableMedSkillPoints}</h3>
              </Item>
            </Grid>
            ...
            <Grid item xs={4}>
              <Item>{dotReturn(medSurgery)}</Item>
            </Grid>
            {availableMedSkillPoints > 0 ? (
              <>
                <Grid item xs={4}>
                  <Item
                    sx={{ cursor: 'pointer' }}
                    onClick={() => selectMedtechRoleSkill('Surgery')}
                  >
                    Select Skill
                  </Item>
                </Grid>
              ...
              <>
                <Grid item xs={4}>
                  <Item>No More Selections Available</Item>
                </Grid>
              </>
            )}
            ...
            {availableMedSkillPoints > 0 ? (
              <>
                <Grid item xs={4}>
                  <Item
                    sx={{ cursor: 'pointer' }}
                    onClick={() => selectMedtechRoleSkill('Pharmaceuticals')}
                  >
                    Select Skill
                  </Item>
                </Grid>
            ...
            {availableMedSkillPoints > 0 ? (
              <>
                <Grid item xs={4}>
                  <Item
                    sx={{ cursor: 'pointer' }}
                    onClick={() => selectMedtechRoleSkill('Cryogenics')}
                  >
                    Select Skill
                  </Item>
                </Grid>
            ...
            <Grid item xs={6}>
              <Item>{dotReturn(charDetail.firstAid)}</Item>
            </Grid>
            <Grid item xs={12}>
              <Item>becomes </Item>
            </Grid>
      ...
      <Grid container spacing={1} padding={2}>
        {roleSelection === 'Maker' ? (
          <>
            ...
            <Grid item xs={12}>
              <Item>
                <h3>Points Available: {availableMakerSkillPoints}</h3>
              </Item>
            </Grid>
            ...
            <Grid item xs={4}>
              <Item>{dotReturn(makerField)}</Item>
            </Grid>
            {availableMakerSkillPoints > 0 ? (
              <>
                <Grid item xs={4}>
                  <Item
                    sx={{ cursor: 'pointer' }}
                    onClick={() => selectMakerRoleSkill('Field Expertise')}
                  >
                    Select Skill
                  </Item>
                </Grid>
            ...
            <Grid item xs={4}>
              <Item>{dotReturn(makerUpgrade)}</Item>
            </Grid>
            {availableMakerSkillPoints > 0 ? (
              <>
                <Grid item xs={4}>
                  <Item
                    sx={{ cursor: 'pointer' }}
                    onClick={() => selectMakerRoleSkill('Upgrade Expertise')}
                  >
                    Select Skill
                  </Item>
                </Grid>
            ...
            <Grid item xs={4}>
              <Item>
                <RoleAbilitiesDialog prop={'Fabrication Expertise'} />
              </Item>
            </Grid>
            <Grid item xs={4}>
              <Item>{dotReturn(makerFab)}</Item>
            </Grid>
            {availableMakerSkillPoints > 0 ? (
              <>
                <Grid item xs={4}>
                  <Item
                    sx={{ cursor: 'pointer' }}
                    onClick={() => selectMakerRoleSkill('Fabrication')}
                  >
                    Select Skill
                  </Item>
                </Grid>
            ...
            <Grid item xs={4}>
              <Item>
                <RoleAbilitiesDialog prop={'Invention Expertise'} />
              </Item>
            </Grid>
            <Grid item xs={4}>
              <Item>{dotReturn(makerInvent)}</Item>
            </Grid>
            {availableMakerSkillPoints > 0 ? (
              <>
                <Grid item xs={4}>
                  <Item
                    sx={{ cursor: 'pointer' }}
                    onClick={() => selectMakerRoleSkill('Invention')}
                  >
                    Select Skill
                  </Item>
                </Grid>
