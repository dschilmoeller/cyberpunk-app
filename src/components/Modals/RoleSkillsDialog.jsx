...
export default function RoleSkillsDialog({ prop }) {
        ...
        return (
          <Grid container>
            <Grid item padding={0.5} xs={12}>
              ...
              allows the Media to pick up rumors passively, and assists in
              digging up new information, rumors, and the like.
            </Grid>
            <Grid item padding={0.5} xs={12}>
              <h3>Rumors:</h3>
              ...
              they're not intentionally staying off grid, simply maintaining
              these networks requires the GM to make secret rolls to see what
              kinds of information makes its way into the Media's hot little
              hands each week. This is the same kind of information that any
              character can find by hitting the street (ie. using Streetwise or
              Investigation to track down information), but requires no legwork
              on the Media's part.
            </Grid>
            <Grid item padding={0.5} xs={12}>
              Like other characters, a Media can attempt to find information out
              intentionally. The passive DV is lower, but only occurs 1/week of
              in game time - they might hear a lot more, but only one item will
              likely be credible.
              <TableContainer component={Paper}>
                <Table
                  sx={{ minWidth: 650 }}
                ...
                >
                  ...
                  <TableBody>
                    <TableRow hover>
                      ...
                      <TableCell>
                        Rumor is hazy and has only the bare minimum information
                    ...
                    <TableRow hover>
                      ...
                      <TableCell>
                        The rumor contains minimal information, but does offer a
                        concrete lead on where to find more information.
                      </TableCell>
                      <TableCell>6</TableCell>
                      <TableCell>7</TableCell>
                    ...
                    <TableRow hover>
                      ...
                      <TableCell>
                        As a typical rumor, but some details of the subject may
                        be available. Multiple avenues to follow up may be
                        included, along with names, places, dates, or times.
                      </TableCell>
                      <TableCell>7</TableCell>
                      <TableCell>8</TableCell>
                    ...
                    <TableRow hover>
                      ...
                      <TableCell>
                        Contains enough information to be published on its own -
                        either someone got sloppy and left too many tracks, or a
                        Deep Throat in the organization spawning the rumor is
                        looking to get the story out.
                      </TableCell>
                      <TableCell>8</TableCell>
                      <TableCell>9</TableCell>
        ...
        return (
          <Grid container>
            ...
            <Grid item padding={0.5} xs={12}>
              ...
              Pharmaceuticals allows the Medtech to synthesize one of the below
              compounds with an Intelligence + Pharmaceuticals roll (DV 6) and
              some reagents. This will produce a number of doses of a given
              compound equal to the number of successes on the roll. The
              reagents have a street value of roughly 200 eddies.
              Pharmaceuticals typically require injection, though they can be
              prepared as a topical, pill, etc. possibly with a higher
              difficulty value as decided by the GM. Applying a dose takes a
              normal action; if the target is unwilling the Medtech can attempt
              to forcibly apply the medicine with a melee attack roll.
              Characters who are <b>not</b> Medtechs cannot administer
              Pharmaceuticals correctly - they cannot evaluate the correct
              dosage. They can certainly try, of course.
            </Grid>
            <Grid item padding={0.5} xs={12}>
              <TableContainer component={Paper}>
                <Table
                ...
                >
                  ...
                  <TableBody>
                    <TableRow hover>
                      ...
                      <TableCell align="left">
                        Speeds up natural healing processes, allowing the
                        recovery of one additional wound when the user rolls
                        their body to recover. Multiple doses cannot stack, and
                        it cannot be used with Speedheal. Each roll uses one
                    ...
                    <TableRow hover>
                      ...
                      <TableCell align="left">
                        When injected, a user affected by a drug, poison, or
                        other intoxicant is immediately purged of the substance.
                        Aggressively. From both ends.
                      </TableCell>
                    </TableRow>
                    ...
                    <TableRow hover>
                      ...
                      <TableCell align="left">
                        When injected, the user immediately rolls Body (DV 6)
                        and recovers stun and lethal wounds as though they'd
                        rested for the appropriate length of time. The user
                        immediately loses one temporary humanity point. Can be
                        used on a target no more than once per day.
                      </TableCell>
                    </TableRow>
                    ...
                    <TableRow hover>
                      ...
                      <TableCell align="left">
                        When administered, the user can ignore all wound
                        penalties for 1 hour. Further, Stun Wounds cannot cause
                        the user to fall unconscious.
                      </TableCell>
                    </TableRow>
                    ...
                    <TableRow hover>
                      ...
                      <TableCell align="left">
                        A dose of surge allows the target to function without
                        sleep for approximately 48 hours. They immediately lose
                        1 point of temporary humanity. For each consecutive dose
                        a user takes in without taking a week off, they lose 2
                        additional humanity (3 for the second, 5 for the 3rd
                        dose, and so on).
                      </TableCell>
                    </TableRow>
                  </TableBody>
                ...
                <TableBody>
                  ...
                  <TableRow hover>
                    ...
                    <TableCell align="left">
                      ...
                      two charges as you learn to operate them more efficiently.
                    </TableCell>
                  </TableRow>
                  ...
                  <TableRow hover>
                    ...
                    <TableCell align="left">
                      ...
                      have three charges due to your mastery of the Cryonic
                      arts!
                    </TableCell>
                  </TableRow>
                </TableBody>
