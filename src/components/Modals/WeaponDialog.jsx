            ...
            case 'Assault Shotgun':
                return (<>
                    <Grid container fontFamily={'serif'}>
                        ...
                        <Grid item padding={1} xs={12}>Shotguns can use the Shellfire special rule. They can be set to wide dispersal, and can hit a 2x2 square up to 3 meters away from the shooter in grid play. This attack has a base DV of 7, cannot be aimed, and additional successes do not increase damage. Thit attack can only be dodged by characters with Reflexes of 6 or higher. In narrative play, the GM has the final say on whether enemies are close enough together for a single shotgun attack to hit more than one target.</Grid>
